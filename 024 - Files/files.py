...
file = open(".\\024 - Files\\my_file.txt")
...
with open(".\\024 - Files\\my_file_w.txt", mode="w") as file:
    file.write("New Text.")
    # closes automatically

with open(".\\024 - Files\\my_file.txt", mode="a") as file:
    file.write("\nNew Text.")
    # closes automatically

with open(".\\024 - Files\\my_file.txt") as file:
    contents = file.read()
    print(contents)
    # closes automatically
