...
class FlightSearch:
    ...
    def __init__(self):
        ...
        self._api_key = "xfsUXwzrT9z36aM48VsQEuCnvAFXMHrD"
        self._api_secret = "vhmbkX0mA6d3apb1"
    ...
    def get_destination_code(self, city_name):
        ...
        Returns:
        str: The IATA code of the first matching city if found; "N/A" if no match is found due 
        to an IndexError, or "Not Found" if no match is found due to a KeyError.
    ...
    def check_flights(self, origin_city_code, destination_city_code, from_time, to_time, is_direct=True):
        ...
        Returns:
            dict or None: A dictionary containing flight offer data if the query is successful; 
